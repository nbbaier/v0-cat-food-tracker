      ...
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Add a new food item to track your cat&apos;s preferences and inventory.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={preference} onValueChange={(v) => setPreference(v as any)}>
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="likes" className="flex items-center gap-2 font-normal">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="dislikes" className="flex items-center gap-2 font-normal">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="unknown" className="flex items-center gap-2 font-normal">
